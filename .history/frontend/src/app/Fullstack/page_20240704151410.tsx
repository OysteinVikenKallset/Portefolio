...
export default function Fullstack() {
    ...
    const { totalUsers, averageNameLength, leapYearBirthdaysCount } = calculateStatistics(users);
    ...
    function calculateStatistics(users) {
        ...
        const leapYearBirthdaysCount = users.filter(user => user.isLeapYearBirthday === "true").length;
          
        return { totalUsers, averageNameLength, leapYearBirthdaysCount };
    }
    ...
    return (
        <div>
            ...
            <p>Antall personer født i skuddår: {leapYearBirthdaysCount}</p>
